...
The current normalized export contains 141 events: 121 EarthScope/GAGE events from the United States and nearby Americas, 18 GeoNet events from New Zealand, and 2 GA/Geoscience Australia events from Australia and the southwest Pacific.
...
当前 normalized export 共包含 141 个事件：121 个 EarthScope/GAGE 美国及美国周边区域事件、18 个 GeoNet 新西兰事件，以及 2 个 GA/Geoscience Australia 澳大利亚和西南太平洋事件。
